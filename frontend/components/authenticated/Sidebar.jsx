    ...
    >
      ...
      <div className={`py-3 border-b border-gray-200 bg-white px-2`}>
        ...
        <button 
          ...
          className="hidden lg:flex absolute -right-3 top-3 w-6 h-6 bg-white border border-gray-300 rounded-full items-center justify-center text-gray-600 hover:text-gray-900 hover:border-gray-400 transition-colors shadow-sm cursor-pointer"
        >
